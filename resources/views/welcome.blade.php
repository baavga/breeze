            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-lg-6 col-md-8">
                    <div class="form-group" style=" margin-top:20px; ">
                        ...
                        {{-- <input  style="height:50px;" type="email" class="form-control"  name ="email" placeholder="Email or Phone" action = "PagesController@store" method= "Post" enctype ='multipart/form-data'> --}}
